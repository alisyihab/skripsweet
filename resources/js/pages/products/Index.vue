                    ...
                    <header class="page-title-bar">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">
                                <router-link :to="{ name: 'products.data' }" v-show="$route.name !== 'products.data' ">
                        ...
                        <div class="d-md-flex align-items-md-start">
                            ...
                            <div class="btn-toolbar">
                                <router-link
                                    ...
                                    v-show="$route.name == 'products.data'" 
                                    class="btn btn-light"
                                >
